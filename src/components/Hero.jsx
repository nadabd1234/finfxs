...
const MetricCard = ({ value, label, indicatorColor, formatValue, isAnimated = false }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`metric-indicator w-3 h-3 ${indicatorColor} rounded-full ${
...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 min-h-[87vh] overflow-hidden"
    >
      {/* Fullscreen diagonal background shape */}
      <svg
        ...
        viewBox="0 0 100 100"
      >
        <polygon points="0,100 100,100 100,0" fill="#2dd4bf" />
        <line x1="0" y1="100" x2="100" y2="0" stroke="white" strokeWidth="0.1" />
      </svg>

      {/* Hero content */}
      <div className="relative z-10 w-full max-w-lg pt-16 pl-8">
        <motion.h1
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 whitespace-nowrap"
        >
        ...
        <motion.p
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-base sm:text-lg text-gray-300 max-w-lg leading-relaxed whitespace-nowrap"
        >
      ...
      {/* Section 1: Backend Solutions Showcase (removed image) */}
      ...
      {/* Section 3: Risk Management (removed image) */}
      ...
      {/* Section 4: Platform Support (removed image) */}
      <div className="py-16 sm:py-20 lg:py-24">
        <div className="text-center mb-8">
          <h2 className="text-3xl sm:text-4xl font-bold text-teal-400 mb-4">
